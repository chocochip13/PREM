...
RefferedOutRates_districtwise <- d %>%
                              ...
                              labs(x = "Districts",
                                   y = "% Referred Out Rate",
                                   title = "ROut Rate With only Assesment",
                                   subtitle = paste0(TotalReferredOut)) + 
                              theme(panel.border = element_blank(),
                                    panel.grid.major = element_blank(),
                                    panel.grid.minor = element_blank(),
...
RefferedOutRates_districtwise
ggsave("Plots/RefferedOutRates_districtwise.jpg", dpi = 300)
write.csv(d, "/Users/ks/Desktop/DDP/PREM/Analysis/ReferredOut/OnlyAssesment.csv", row.names = FALSE)

```

ROut without Assesment
```{r}
...
RefferedOutRates_districtwise <- d %>%
                              ...
                              labs(x = "Districts",
                                   y = "% Referred Out Rate",
                                   title = "Referred Out Rate without Assesment",
                                   subtitle = paste0(TotalReferredOut)) + 
                              theme(panel.border = element_blank(),
                                    panel.grid.major = element_blank(),
                                    panel.grid.minor = element_blank(),
